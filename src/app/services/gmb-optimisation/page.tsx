...
const features = [
  { icon: MapPin, title: "Profile Optimization", description: "Complete optimization of your Google Business Profile with accurate information and compelling descriptions." },
  { icon: Search, title: "Local SEO", description: "Improve your local search rankings and visibility in Google Maps and local search results." },
  { icon: MessageSquare, title: "Review Management", description: "Professional responses to customer reviews to build trust and improve ratings." },
  { icon: BarChart3, title: "Performance Analytics", description: "Detailed insights into profile views, searches, and customer actions." },
  { icon: TrendingUp, title: "Growth Strategy", description: "Data-driven strategies to increase visibility and attract more customers." },
  { icon: Star, title: "Reputation Building", description: "Systematic approach to building and maintaining a 5-star reputation." },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl leading-relaxed">
              Maximize your local visibility and attract more customers with our comprehensive 
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 p-12 lg:p-20 text-center">
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-indigo-100 mb-10">
                Get in touch today and start dominating local search results.
              </p>
              <Link href="/contact">
