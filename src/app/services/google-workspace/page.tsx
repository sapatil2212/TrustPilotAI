...
const features = [
  { icon: Mail, title: "Gmail for Business", description: "Professional email with your domain name and advanced security features." },
  { icon: Calendar, title: "Shared Calendars", description: "Schedule meetings and coordinate with your team effortlessly." },
  { icon: Cloud, title: "Google Drive", description: "Secure cloud storage with 30GB+ space per user and file sharing." },
  { icon: Users, title: "Collaboration Tools", description: "Docs, Sheets, and Slides for real-time team collaboration." },
  { icon: Shield, title: "Advanced Security", description: "Enterprise-grade security and admin controls for your data." },
  { icon: Star, title: "24/7 Support", description: "Round-the-clock support from Google and our dedicated team." },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl leading-relaxed">
              Empower your team with the complete Google Workspace suite. 
              Professional email, cloud storage, and collaboration tools for modern businesses.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight">
              Complete Business Productivity
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Everything your team needs to collaborate and succeed.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 p-12 lg:p-20 text-center">
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-indigo-100 mb-10">
                Get Google Workspace set up for your business today.
              </p>
              <Link href="/contact">
